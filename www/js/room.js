...
Room.prototype.sendMessage = function(msgDetails) {
  var data = { sender: msgDetails.username, room: this.name, message: msgDetails.message, isLog: false, color: msgDetails.color, timestamp: moment().calendar(), socketId: msgDetails.socketId };
